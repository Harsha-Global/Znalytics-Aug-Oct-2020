...
namespace ListExample
{
    class Program
    {
        ...
        {
            //collection
            ArrayList states = new ArrayList() { "Telangana", "Andhra Pradesh", "Madhya Pradesh" };

            //AddRange
            states.AddRange(new ArrayList() { "West Bengal", "Maharashtra", "Gujarat" });
            ...
            //InsertRange
            states.InsertRange(4, new ArrayList() { "Tamilnadu", "Kerala", "Karnataka" });
